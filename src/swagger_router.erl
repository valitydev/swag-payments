...
get_operations() ->
    #{ 
        ...
        'GetPaymentConversionStats' => #{
            ...
            method => <<"GET">>,
            handler => 'swagger_analytics_handler'
        },
        'GetPaymentGeoStats' => #{
        ...
        'GetCategories' => #{
            ...
            method => <<"GET">>,
            handler => 'swagger_categories_handler'
        },
        'GetCategoryByRef' => #{
        ...
        'CreateClaim' => #{
            ...
            method => <<"POST">>,
            handler => 'swagger_claims_handler'
        },
        'GetClaimByID' => #{
        ...
        'GetContractAdjustmentByID' => #{
            ...
            method => <<"GET">>,
            handler => 'swagger_contracts_handler'
        },
        ...
        'GetCountries' => #{
            ...
            method => <<"GET">>,
            handler => 'swagger_countries_handler'
        },
        'GetCountryByID' => #{
        ...
        'CreateBinding' => #{
            ...
            method => <<"POST">>,
            handler => 'swagger_customers_handler'
        },
        'CreateCustomer' => #{
        ...
        'GetLocationsNames' => #{
            ...
            method => <<"GET">>,
            handler => 'swagger_geo_handler'
        },
        'CreateInvoiceTemplate' => #{
            path => "/v2/processing/invoice-templates",
            method => <<"POST">>,
            handler => 'swagger_invoice_templates_handler'
        },
        ...
        'CreateInvoice' => #{
            ...
            method => <<"POST">>,
            handler => 'swagger_invoices_handler'
        },
        ...
        'ActivateMyParty' => #{
            ...
            method => <<"PUT">>,
            handler => 'swagger_parties_handler'
        },
        'ActivatePartyByID' => #{
        ...
        'GetPaymentInstitutionByRef' => #{
            ...
            method => <<"GET">>,
            handler => 'swagger_payment_institutions_handler'
        },
        ...
        'CancelPayment' => #{
            ...
            method => <<"POST">>,
            handler => 'swagger_payments_handler'
        },
        'CapturePayment' => #{
        ...
        'CreatePayout' => #{
            ...
            method => <<"POST">>,
            handler => 'swagger_payouts_handler'
        },
        'GetPayout' => #{
        ...
        'CreateReport' => #{
            ...
            method => <<"POST">>,
            handler => 'swagger_reports_handler'
        },
        ...
        'SearchInvoices' => #{
            ...
            method => <<"GET">>,
            handler => 'swagger_search_handler'
        },
        'SearchPayments' => #{
        ...
        'CreatePaymentResource' => #{
            ...
            method => <<"POST">>,
            handler => 'swagger_tokens_handler'
        },
        'GetTradeBlocByID' => #{
            path => "/v2/processing/tradeblocs/:tradeBlocID",
            method => <<"GET">>,
            handler => 'swagger_trade_blocs_handler'
        },
        'GetTradeBlocs' => #{
        ...
        'CreateWebhook' => #{
            ...
            method => <<"POST">>,
            handler => 'swagger_webhooks_handler'
        },
        'DeleteWebhookByID' => #{
