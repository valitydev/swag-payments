...
-spec activate_shop(Endpoint :: swag_client:endpoint(), Params :: map()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
activate_shop(Endpoint, Params) ->
    activate_shop(Endpoint, Params, []).

-spec activate_shop(Endpoint :: swag_client:endpoint(), Params :: map(), Opts :: swag_client:transport_opts()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
activate_shop(Endpoint, Params, Opts) ->
    process_response(swag_client_procession:process_request(
        put,
        swag_client_utils:get_url(Endpoint, "/v2/processing/shops/:shopID/activate"),
        Params,
...
-spec get_shop_by_id(Endpoint :: swag_client:endpoint(), Params :: map()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
get_shop_by_id(Endpoint, Params) ->
    get_shop_by_id(Endpoint, Params, []).

-spec get_shop_by_id(Endpoint :: swag_client:endpoint(), Params :: map(), Opts :: swag_client:transport_opts()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
get_shop_by_id(Endpoint, Params, Opts) ->
    process_response(swag_client_procession:process_request(
        get,
        swag_client_utils:get_url(Endpoint, "/v2/processing/shops/:shopID"),
        Params,
...
-spec get_shops(Endpoint :: swag_client:endpoint(), Params :: map()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
get_shops(Endpoint, Params) ->
    get_shops(Endpoint, Params, []).

-spec get_shops(Endpoint :: swag_client:endpoint(), Params :: map(), Opts :: swag_client:transport_opts()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
get_shops(Endpoint, Params, Opts) ->
    process_response(swag_client_procession:process_request(
        get,
        swag_client_utils:get_url(Endpoint, "/v2/processing/shops"),
        Params,
...
-spec suspend_shop(Endpoint :: swag_client:endpoint(), Params :: map()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
suspend_shop(Endpoint, Params) ->
    suspend_shop(Endpoint, Params, []).

-spec suspend_shop(Endpoint :: swag_client:endpoint(), Params :: map(), Opts :: swag_client:transport_opts()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
suspend_shop(Endpoint, Params, Opts) ->
    process_response(swag_client_procession:process_request(
        put,
        swag_client_utils:get_url(Endpoint, "/v2/processing/shops/:shopID/suspend"),
        Params,
